...
public class KottlergMod {
    ...
    public void Init(FMLInitializationEvent event) {
        ...
        OreAluminum = new OreAluminum(oreAluminumID, Material.iron).setUnlocalizedName("tilealuminumore");
    ...
    private static void languageRegisters(){
        LanguageRegistry.addName(OreAluminum, "Aluminume Ore");
    }
    @PostInit
